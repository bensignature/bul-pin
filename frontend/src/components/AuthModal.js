...
const AuthModal = ({ onClose, onLogin }) => {
  ...
  const handlePinterestLogin = () => {
    ...
    // In a real application, this would redirect to Pinterest OAuth
          ...
          {!showTokenInput ? (
            <>
              <div className="auth-info">
                <p>Connect your Pinterest account to save images to your boards</p>
              </div>

              <div className="auth-methods">
                <button 
                  onClick={handlePinterestLogin}
                  className="pinterest-login-btn"
                >
                ...
                <div className="demo-section">
                  ...
                  <p className="demo-note">
                    Use demo account for testing (no actual Pinterest connection)
                  </p>
                </div>
              </div>
            </>
            ...
            <div className="token-input-section">
              <div className="auth-info">
                <p>Enter your Pinterest access token to continue</p>
                <p className="token-help">
                  You can get your access token from the Pinterest Developer Console
                </p>
              </div>
              ...
              <div className="demo-section">
                <button 
                  onClick={handleDemoLogin}
                  className="demo-login-btn small"
                >
                  Skip and use demo account
                </button>
              </div>
            </div>
          )}
